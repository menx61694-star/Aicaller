...
- [x] VAD — deterministic PCM16 mono energy VAD with configurable speech/silence hysteresis and CI-covered transition/format tests; runtime/provider calibration remains pending
